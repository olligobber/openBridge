...
(function($PS) {
          ...
          return function (hide) {
              return function (sel) {
                  return function (options) {
                      ...
                      return Halogen_HTML_Elements.select([ Halogen_HTML_Events.onValueChange(Control_Bind.composeKleisli(Data_Maybe.bindMaybe)(Data_Function.flip(Data_Map_Internal.lookup(Data_Ord.ordString))(forwardMap))(act)), Halogen_HTML_Properties.value(Data_Maybe.maybe("- Select one -")(Control_Category.identity(Control_Category.categoryFn))(Data_Map_Internal.lookup(dictOrd)(sel)(backwardMap))) ])(Data_Functor.map(Data_Functor.functorArray)(option)(Data_Array.filter((function () {
                          var $47 = Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean);
                          return function ($48) {
                              return $47(hide(Data_Tuple.snd($48)));
                          };
                      })())(options)));
                  };
              };
      ...
      return function (v1) {
          ...
          if (v1 instanceof Data_Maybe.Just && v1.value0 instanceof Hand.Hons) {
              ...
              if (Data_Boolean.otherwise) {
                  ...
                  throw new Error("Failed pattern match at Main (line 73, column 19 - line 75, column 50): " + [ v.suit.constructor.name ]);
              };
          };
          throw new Error("Failed pattern match at Main (line 68, column 1 - line 68, column 45): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var handleButton = function (v) {
      if (v instanceof SetDeclarer) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Hand.setDeclarer(v.value0)(v.value1));
      };
      if (v instanceof SetAllPass) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Hand.setAllPass);
      };
      if (v instanceof SetLevel) {
          var v1 = Hand.toLevel(v.value0);
          if (v1 instanceof Data_Maybe.Nothing) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Hand.setLevel(v1.value0));
          };
          throw new Error("Failed pattern match at Main (line 144, column 33 - line 146, column 41): " + [ v1.constructor.name ]);
      };
      if (v instanceof SetSuit) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Hand.setSuit(v.value0));
      };
      if (v instanceof IncreaseTricks) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (hand) {
              var oldtricks = Data_Maybe.maybe(Data_Functor.map(Data_Maybe.functorMaybe)(Hand.defaultTricks)(hand.level))(Data_Maybe.Just.create)(hand.tricks);
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  ...
                  if (v2 instanceof Data_Maybe.Just) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Hand.setTricks(v2.value0));
                  };
                  throw new Error("Failed pattern match at Main (line 153, column 19 - line 155, column 62): " + [ v2.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 151, column 5 - line 155, column 62): " + [ v1.constructor.name ]);
          });
      };
      if (v instanceof DecreaseTricks) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (hand) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Main (line 161, column 19 - line 163, column 62): " + [ v2.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 159, column 5 - line 163, column 62): " + [ v1.constructor.name ]);
          });
      };
      if (v instanceof SetDouble) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Hand.setDoubled(v.value0));
      };
      if (v instanceof SetHonours) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Hand.setHonours(v.value0));
      };
      throw new Error("Failed pattern match at Main (line 140, column 1 - line 141, column 45): " + [ v.constructor.name ]);
  };
  var button = function (v) {
      return function (name) {
          return function (act) {
              ...
              throw new Error("Failed pattern match at Main (line 42, column 1 - line 42, column 71): " + [ v.constructor.name, name.constructor.name, act.constructor.name ]);
          };
      };
  };
  ...
  var component = buttonsComponent;
  ...
  var render = renderButtons;
  exports["SetDeclarer"] = SetDeclarer;
  exports["SetAllPass"] = SetAllPass;
  exports["SetLevel"] = SetLevel;
  exports["SetSuit"] = SetSuit;
  exports["IncreaseTricks"] = IncreaseTricks;
  exports["DecreaseTricks"] = DecreaseTricks;
  exports["SetDouble"] = SetDouble;
  exports["SetHonours"] = SetHonours;
  exports["buttonsComponent"] = buttonsComponent;
  exports["button"] = button;
  exports["select"] = select;
  exports["hideHons"] = hideHons;
