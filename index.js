...
(function($PS) {
  ...
  var toTricks = function (x) {
      ...
      throw new Error("Failed pattern match at Hand (line 80, column 1 - line 80, column 32): " + [ x.constructor.name ]);
  };
  var toLevel = function (x) {
      ...
      throw new Error("Failed pattern match at Hand (line 73, column 1 - line 73, column 30): " + [ x.constructor.name ]);
  };
  var showSuit = function (v) {
      ...
      throw new Error("Failed pattern match at Hand (line 42, column 1 - line 42, column 27): " + [ v.constructor.name ]);
  };
  ...
  var result = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Hand (line 94, column 1 - line 94, column 42): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var renderResult = function (v) {
      ...
      throw new Error("Failed pattern match at Hand (line 101, column 1 - line 101, column 33): " + [ v.constructor.name ]);
  };
  var renderContract = function (contract) {
      ...
      var level = (function () {
          ...
          throw new Error("Failed pattern match at Hand (line 208, column 13 - line 210, column 37): " + [ contract.level.constructor.name ]);
      })();
      var doubling = (function () {
          ...
          throw new Error("Failed pattern match at Hand (line 212, column 16 - line 215, column 26): " + [ contract.doubled.constructor.name ]);
      })();
  ...
  var renderHand = function (hand) {
      ...
      throw new Error("Failed pattern match at Hand (line 218, column 1 - line 218, column 29): " + [ hand.constructor.name ]);
  };
  var newHand = {
      allPass: false,
      declarer: Data_Maybe.Nothing.value,
...
(function($PS) {
  ...
  var option = function (name) {
      return function (act) {
          return Halogen_HTML_Elements.option([ Halogen_HTML_Events.onClick(function (v) {
  ...
  var handleButton = function (v) {
      ...
      if (v instanceof SetLevel) {
          ...
          throw new Error("Failed pattern match at Main (line 91, column 33 - line 93, column 41): " + [ v1.constructor.name ]);
      };
      ...
      if (v instanceof IncreaseTricks) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (hand) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Main (line 100, column 19 - line 102, column 62): " + [ v2.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 98, column 5 - line 102, column 62): " + [ v1.constructor.name ]);
          });
      };
      if (v instanceof DecreaseTricks) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (hand) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Main (line 108, column 19 - line 110, column 62): " + [ v2.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 106, column 5 - line 110, column 62): " + [ v1.constructor.name ]);
          });
      };
      ...
      throw new Error("Failed pattern match at Main (line 87, column 1 - line 88, column 45): " + [ v.constructor.name ]);
  };
  ...
  var renderButtons = function (hand) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("buttons") ])([ button("N")(new SetDeclarer("N", Score.We.value)), button("E")(new SetDeclarer("E", Score.They.value)), button("S")(new SetDeclarer("S", Score.We.value)), button("W")(new SetDeclarer("W", Score.They.value)), button("AP")(SetAllPass.value), button("1")(new SetLevel(1)), button("2")(new SetLevel(2)), button("3")(new SetLevel(3)), button("4")(new SetLevel(4)), button("5")(new SetLevel(5)), button("6")(new SetLevel(6)), button("7")(new SetLevel(7)), button("\u2663")(new SetSuit(Hand.Clubs.value)), button("\u2666")(new SetSuit(Hand.Diamonds.value)), button("\u2665")(new SetSuit(Hand.Hearts.value)), button("\u2660")(new SetSuit(Hand.Spades.value)), button("\ud83d\udeab")(new SetSuit(Hand.NoTrumps.value)), button("-")(DecreaseTricks.value), Halogen_HTML_Core.text(Hand.renderHand(hand)), button("+")(IncreaseTricks.value), Halogen_HTML_Elements.select([ Halogen_HTML_Properties.id_("double") ])([ option("Undoubled")(new SetDouble(Hand.Undoubled.value)), option("Doubled")(new SetDouble(Hand.Doubled.value)), option("Redoubled")(new SetDouble(Hand.Redoubled.value)) ]), Halogen_HTML_Elements.select([ Halogen_HTML_Properties.id_("honours") ])([ option("No honors")(new SetHonours(Hand.None.value)), option("We have 4")(SetHonours.create(new Hand.Hons(Score.We.value, Hand.Four.value))), option("We have 5")(SetHonours.create(new Hand.Hons(Score.We.value, Hand.Five.value))), option("We have aces")(SetHonours.create(new Hand.Hons(Score.We.value, Hand.Aces.value))), option("They have 4")(SetHonours.create(new Hand.Hons(Score.They.value, Hand.Four.value))), option("They have 5")(SetHonours.create(new Hand.Hons(Score.They.value, Hand.Five.value))), option("They have aces")(SetHonours.create(new Hand.Hons(Score.They.value, Hand.Aces.value))) ]) ]);
  };
